...
namespace ImmersionHelper.Data.Migrations
{
    ...
    [Migration("20230324130411_RelatedArticle")]
    partial class RelatedArticle
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ImmersionHelper.Data.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ReferencePostId")
                        .HasColumnType("int");

                    b.Property<int?>("RelatedToArticleId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ImmersionHelper.Data.Post", b =>
                {
                    b.HasOne("ImmersionHelper.Data.ApplicationUser", "Creator")
                        .WithMany()
                        .HasForeignKey("CreatorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ImmersionHelper.Data.Article", "RelatedToArticle")
                        .WithMany()
                        .HasForeignKey("RelatedToArticleId");

                    b.Navigation("Creator");

                    b.Navigation("RelatedToArticle");
                });
